...
insert into staff (staff_id, building_num, name, email, home_addr, dob, gender, title)
    values (1007, 1, "Dexter Morris", "dextermorris@hotmail.com", "4 Goldfield Rd", "01/07/1962", "cleaner");

insert into staff (staff_id, building_num, name, email, home_addr, dob, gender, title)
    values (1008, 1, "August Hickman", "august@yahoo.com", "514 S Magnolia St", "10/29/1978", "administrative assistant");

insert into staff (staff_id, building_num, name, email, home_addr, dob, gender, title)
    values (1009, 2, "Jadon Figueroa", "jadenfig@gmail.com", "71 Pilgrim Ave", "12/06/1980", "hall manager");

insert into staff (staff_id, building_num, name, email, home_addr, dob, gender, title)
    values (1010, 2, "Luciano Golden", "lucgold@hotmail.com", "76 Ryan Ave", "06/08/1972", "cleaner");

insert into staff (staff_id, building_num, name, email, home_addr, dob, gender, title)
    values (1011, 2, "Ashton Arnold", "ashton@gmail.com", "36 Talbot Ave", "07/01/1991", "administrative assistant");
...
insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2003, "Franky Gordon", "313 Carson Lane", "520-643-7591", "frankgord@hotmail.com", "male", "01/02/1997", "postgrad", "English", 1001);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2004, "Sammy Smith", "831 Walnut Drive", "520-871-4352", "sammay@yahoo.com", "male", "02/01/1996", "postgrad", "Engineering", 1005);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2005, "Alexis Madden", "296 Hawthorne Ave", "520-631-7869", "madalex@gmail.com", "female", "08/09/1999", "undergrad", "Chemistry", 1004);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2006, "Rory Parker", "751 Henry Lane", "520-439-1123", "rory@yahoo.com", "male", "09/30/2001", "undergrad", "Math", 1002);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2007, "John Jacobs", "123 Drury Lane", "520-119-9103", "jj@gmail.com", "male", "12/31/2002", "undergrad", "English", 1001);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2008, "Jess Young", "561 E North Ave", "520-768-9212", "jesss@yahoo.com", "female", "12/12/2000", "undergrad", "Biology", 1003);

insert into student (id_num, name, home_addr, phone_num, email, gender, dob, category, major, minor, adviser_id)
    values (2009, "Gale Gates", "3498 S Pillar Rd", "602-907-8904", "ggates@gmail.com", "female", "11/11/1999", "undergrad", "Chemistry", 1004);
